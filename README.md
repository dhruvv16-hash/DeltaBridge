...
### 2. Database Setup
The SQLite database file (`instance/local.db`) is automatically initialized with the correct database schema (accounts, settings, strategy states, and trade logs) on the first startup of the Flask app:
```python
